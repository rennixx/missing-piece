...
1. **Skill Router & Reasoning Engine:** [`skills/missing-piece/SKILL.md`](file:///c:/projects/missing-piece/skills/missing-piece/SKILL.md) routing 14 detector families (`MP-LC` through `MP-OB`), backed by 9 reference guides in [`skills/missing-piece/references/`](file:///c:/projects/missing-piece/skills/missing-piece/references), 3 canonical examples in [`skills/missing-piece/examples/`](file:///c:/projects/missing-piece/skills/missing-piece/examples), and [`skills/missing-piece/templates/audit-report.md`](file:///c:/projects/missing-piece/skills/missing-piece/templates/audit-report.md).
